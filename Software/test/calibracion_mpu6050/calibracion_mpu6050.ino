...
void setup() {
  ...
  Wire.begin(18,19); // Iniciando I2C
...
void loop() {
  ...
  if (Serial.available()) {
    Serial.read();  // Leer el carácter de parada
    
    // Imprimir offsets finales
    Serial.println("\n\n=== CALIBRACION COMPLETA ===");
    Serial.println("Copia estos valores en main.ino:");
    Serial.print("sensor.setXAccelOffset("); Serial.print(ax_o); Serial.println(");");
    Serial.print("sensor.setYAccelOffset("); Serial.print(ay_o); Serial.println(");");
    Serial.print("sensor.setZAccelOffset("); Serial.print(az_o); Serial.println(");");
    Serial.print("sensor.setXGyroOffset("); Serial.print(gx_o); Serial.println(");");
    Serial.print("sensor.setYGyroOffset("); Serial.print(gy_o); Serial.println(");");
    Serial.print("sensor.setZGyroOffset("); Serial.print(gz_o); Serial.println(");");
